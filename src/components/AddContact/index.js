...
const AddPost = ({ contacts, addContact, closeModal }) => {
      ...
      <div class="modal-dialog">
        <div class="modal-content shadow">
          <div class="modal-header">
            ...
            <span className="close" onClick={() => closeModal("add")} role="button">X</span>
          </div>
          <div class="modal-body">
            <div className="container-fluid">
              {/* <h1 className="text-center text-dark py-3 display-2">Add Data</h1> */}
              <div className="row">
                <div className="col-sm-12 p-5 mx-auto">
                  <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                      <input className="btn btn-block btn-dark" type="submit" value="Submit" />
                    </div>
                  </form>
                </div>
              </div>
